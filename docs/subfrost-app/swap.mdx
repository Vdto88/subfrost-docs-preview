...
When swapping **to BTC**, the reverse happens: your token swaps to frBTC, then unwraps to native BTC automatically. There is a 3 to 7 block confirmation period (safety mechanism) before the SUBFROST protocol sends the unwrapped BTC.
