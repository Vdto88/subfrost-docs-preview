...
将 NFT 仓位拆分为两部分。**NFT** 保留 FIRE 收益权。一个名为 **FIRE-PT-0** 的可互换 **wLP** 代币则承载 LP 索取权，你可以单独转让或出售它。合并（merge）操作可以将仓位重新组合到一起。
...
一旦纪元到期，任何持有 wLP（FIRE-PT-0）的人都可以直接将其赎回为 LP，无需持有 NFT。
